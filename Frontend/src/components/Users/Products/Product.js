...
import { fetchOneProductAction } from "../../../redux/slices/products/productSlices";
import {
  addOrderToCartaction,
  getItemFromStorageAction,
...
export default function Product() {
  ...
  //get alrady exist cart items with same id
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center">
                <p className="text-sm text-gray-700">
                  {product?.reviews.length > 0 ? product?.averageRating : 0.0}
