...
const offers = [
  {
    name: "Check The Coupons",
    description: "Get an exclusive off for codes",
    href: "#",
  },
  {
  ...
  {
    name: "The Best Discount From Shoe House",
    description: "15% off your Any order",
    href: "#",
  },
];
                ...
                <div className="mx-auto max-w-2xl py-24 lg:max-w-none lg:py-64">
                  <div className="lg:pr-16">
                    <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl xl:text-6xl">
                      Shoes, Space, Simplified
                    </h1>
                    <p className="mt-4 text-xl text-gray-600">
                      Revolutionizing Shoe Organization in the Digital Age.
                    </p>
                    <div className="mt-6">
                      <Link
                        to="/all-categories"
